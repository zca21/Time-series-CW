...
```{r}
ts6_period<-ts(tser06[1:240],start=0,end=(24-1/12),frequency=12)
tmp<-stl(ts6_period,s.window="periodic")
comps <- tmp$time.series
plot(comps[,3])
plot(diff(comps[,3]))
plot(diff(diff(comps[,3])))
plot(diff(diff(diff(comps[,3]))))

ts6_period<-ts(tser06[1:240],start=0,end=(5-(1/48)),frequency=48)
plot(stl(ts6_period,s.window="periodic"))
tmp<-stl(ts6_period,s.window="periodic")
comps <- tmp$time.series
plot(comps[,3])
plot(diff(comps[,3]))
...
ts6_period<-ts(tser06[1:240],start=0,end=(6-(1/60)),frequency=60)
plot(stl(ts6_period,s.window="periodic"))
tmp<-stl(ts6_period,s.window="periodic")
comps <- tmp$time.series
plot(comps[,3])
...
ts6_period<-ts(tser06[1:240],start=0,end=(10-(1/24)),frequency=24)
plot(stl(ts6_period,s.window="periodic"))
tmp<-stl(ts6_period,s.window="periodic")
comps <- tmp$time.series
plot(comps[,3])
